...
scoreboard players set @s[scores={wb_gob_type=1}] wb_page_last 0
scoreboard players set @s[scores={wb_gob_type=2}] wb_page_last 0
scoreboard players set @s[scores={wb_gob_type=3}] wb_page_last 0
scoreboard players set @s[scores={wb_gob_type=4}] wb_page_last 0