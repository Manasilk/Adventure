...
scoreboard players set #dbc.core build_update 3
scoreboard players set #dbc.core build_hotfix 5
scoreboard players set #dbc.core build_revision 1222
scoreboard players set #dbc.core build_pd_d 10
