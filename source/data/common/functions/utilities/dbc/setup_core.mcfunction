...
scoreboard players set #dbc.core build_hotfix 15
scoreboard players set #dbc.core build_revision 2811
scoreboard players set #dbc.core build_pd_d 06
scoreboard players set #dbc.core build_pd_m 07
