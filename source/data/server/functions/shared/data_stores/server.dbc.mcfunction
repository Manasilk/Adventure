...
scoreboard objectives add hours dummy {"translate":"dbc.server.hours"}
scoreboard objectives add minutes dummy {"translate":"dbc.server.minutes"}
...
scoreboard objectives add OUTLANDS dummy