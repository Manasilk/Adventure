scoreboard objectives add quest_id dummy {"translate":"dbc.quests.quest_id"}
...
scoreboard objectives add quest_kill3 dummy {"translate":"dbc.quests.quest_kill3"}
scoreboard objectives add npc_count0 dummy {"translate":"dbc.quests.npc_count0"}
scoreboard objectives add npc_count1 dummy {"translate":"dbc.quests.npc_count1"}
scoreboard objectives add npc_count2 dummy {"translate":"dbc.quests.npc_count2"}
scoreboard objectives add npc_count3 dummy {"translate":"dbc.quests.npc_count3"}
scoreboard objectives add quest_item0 dummy {"translate":"dbc.quests.quest_item0"}
scoreboard objectives add quest_item1 dummy {"translate":"dbc.quests.quest_item1"}
scoreboard objectives add quest_item2 dummy {"translate":"dbc.quests.quest_item2"}
scoreboard objectives add quest_item3 dummy {"translate":"dbc.quests.quest_item3"}
scoreboard objectives add item_count0 dummy {"translate":"dbc.quests.item_count0"}
