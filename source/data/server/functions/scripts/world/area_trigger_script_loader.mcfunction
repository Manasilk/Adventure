...
execute if entity @s[tag=area_trigger_abandoned_mineshaft] if score #dbc.server cfg.do_spawn = #bool true run function server:scripts/world/area_trigger_abandoned_mineshaft
