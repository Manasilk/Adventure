...
execute as @a[tag=!SPELL_AURA_INVISIBILITY,tag=ENTITY_FLAG_IN_COMBAT,distance=0..15.999] run scoreboard players operation #dbc.temp entity_level += @s entity_reclvl
