...
execute as @e[tag=BountyPOI.DirectionTooltipTrigger] at @s run function server:game/miscellaneous/marker/get_direction_info

function server:game/miscellaneous/marker/get_poi_distance
