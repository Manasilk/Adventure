...
tellraw @s {"translate":"server.readme_msg","with":[{"text":"https://github.com/srQianna/StoneCore","clickEvent":{"action":"open_url","value":"https://www.google.com/"},"color":"white","underlined":true}],"color":"yellow"}
