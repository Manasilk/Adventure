...
scoreboard players enable @s gmisland
scoreboard players enable @s xyz
scoreboard players enable @s daytime
scoreboard players enable @s tooltip

scoreboard players enable @s mono
scoreboard players enable @s average
...
scoreboard players enable @s spawn_triggers
