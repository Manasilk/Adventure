...
execute if entity @s[tag=QUEST_OBJECTIVE_TRIGGER] as @a[distance=0..2.999] if score @s player_id = #dbc.temp TEMP run tag @s add ENTITY_FLAG_QUEST_TARGET
execute if entity @s[tag=QUEST_OBJECTIVE_MONSTER] as @a[distance=0..31.999] if score @s player_id = #dbc.temp TEMP run tag @s add ENTITY_FLAG_QUEST_TARGET
execute if entity @s[tag=QUEST_OBJECTIVE_ITEM] as @a[distance=0..31.999] if score @s player_id = #dbc.temp TEMP run tag @s add ENTITY_FLAG_QUEST_TARGET
execute if entity @s[tag=QUEST_OBJECTIVE_TALK_TO] as @a[distance=0..5.299] if score @s player_id = #dbc.temp TEMP run tag @s add ENTITY_FLAG_QUEST_TARGET
