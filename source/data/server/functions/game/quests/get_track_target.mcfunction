...
execute if entity @s[tag=QUEST_OBJECTIVE_TRIGGER] run tag @a[tag=ENTITY_FLAG_QUEST_TARGET,distance=5.300..] remove ENTITY_FLAG_QUEST_TARGET
...
execute if entity @s[tag=QUEST_OBJECTIVE_TALK_TO] run tag @a[tag=ENTITY_FLAG_QUEST_TARGET,distance=4.000..] remove ENTITY_FLAG_QUEST_TARGET
#check for the owner of this area_trigger
scoreboard players operation #dbc.temp TEMP = @s owner_id
execute if entity @s[tag=QUEST_OBJECTIVE_TRIGGER] as @a[distance=0..5.299] if score @s player_id = #dbc.temp TEMP run tag @s add _e.get_owner
...
execute if entity @s[tag=QUEST_OBJECTIVE_TALK_TO] as @a[distance=0..3.999] if score @s player_id = #dbc.temp TEMP run tag @s add _e.get_owner
...
execute if entity @s[tag=QUEST_OBJECTIVE_TRIGGER] as @a[tag=_e.get_owner,distance=0..5.299] if score @s quest_id = #dbc.temp TEMP run tag @s add ENTITY_FLAG_QUEST_TARGET
...
execute if entity @s[tag=QUEST_OBJECTIVE_TALK_TO] as @a[tag=_e.get_owner,distance=0..3.999] if score @s quest_id = #dbc.temp TEMP run tag @s add ENTITY_FLAG_QUEST_TARGET
#if the owner doesnt have the same quest_id as the area trigger the trigger destroys itself
execute if entity @s[tag=QUEST_OBJECTIVE_TRIGGER] as @a[tag=_e.get_owner,distance=0..5.299] unless score @s quest_id = #dbc.temp TEMP run tag @s add _e.delete_area_trigger
...
execute if entity @s[tag=QUEST_OBJECTIVE_TALK_TO] as @a[tag=_e.get_owner,distance=0..3.999] unless score @s quest_id = #dbc.temp TEMP run tag @s add _e.delete_area_trigger
...
execute if entity @s[tag=QUEST_OBJECTIVE_TRIGGER] run tag @a[tag=_e.get_owner,distance=0..5.299] remove _e.get_owner
...
execute if entity @s[tag=QUEST_OBJECTIVE_TALK_TO] run tag @a[tag=_e.get_owner,distance=0..3.999] remove _e.get_owner
