...
scoreboard players operation @s[tag=!AREA_TRIGGER_LINKED_TO] owner_id = @a[tag=_h.gossip_break,distance=0..5.299,limit=1] player_id
scoreboard players operation @s[tag=!AREA_TRIGGER_LINKED_TO] quest_id = @a[tag=_h.gossip_break,distance=0..5.299,limit=1] quest_id
