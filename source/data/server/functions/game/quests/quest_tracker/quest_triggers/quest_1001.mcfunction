...
execute as @e[type=#server:area_trigger,tag=ENTITY_FLAG_QUEST_TRIGGER,tag=AREA_TRIGGER_LINKED_TO,scores={TEMP=4},distance=0..0.001,sort=nearest,limit=1] at @s run function server:game/quests/quest_objective/linked/quest_1001/3
