...
execute if score @s[tag=!_e.complete_objective_0,scores={task_objectives=1..,npc_count0=1..}] npc_count0 >= @s quest_kill0 run scoreboard players add @s task_pobj_count 1
execute if score @s[tag=!_e.complete_objective_0,scores={task_objectives=1..,npc_count0=1..}] npc_count0 >= @s quest_kill0 run tag @s add _e.complete_objective_0
#second objective field
execute if score @s[tag=!_e.complete_objective_1,scores={task_objectives=2..,npc_count1=1..}] npc_count1 >= @s quest_kill1 run scoreboard players add @s[tag=!_e.complete_objective_1] task_pobj_count 1
execute if score @s[tag=!_e.complete_objective_1,scores={task_objectives=2..,npc_count1=1..}] npc_count1 >= @s quest_kill1 run tag @s add _e.complete_objective_1
#third objective field
execute if score @s[tag=!_e.complete_objective_2,scores={task_objectives=3..,npc_count2=1..}] npc_count2 >= @s quest_kill2 run scoreboard players add @s[tag=!_e.complete_objective_2] task_pobj_count 1
execute if score @s[tag=!_e.complete_objective_2,scores={task_objectives=3..,npc_count2=1..}] npc_count2 >= @s quest_kill2 run tag @s add _e.complete_objective_2
