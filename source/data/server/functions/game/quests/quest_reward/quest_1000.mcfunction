tag @a[scores={_h.interact=1..},distance=0..5.299] remove QUEST_REWARD_1000
tag @a[scores={_h.interact=1..},distance=0..5.299] remove QUEST_ACCEPT_1000
tag @a[scores={_h.interact=1..},distance=0..5.299] add QUEST_COMPLETE_1000
