execute if entity @s[tag=AREA_TRIGGER_LINKED_TO] if entity @a[tag=ENTITY_FLAG_QUEST_TARGET,distance=0..3.999] run function internal:world/quests/get_quest_status
