...
execute if entity @s[tag=world_builder.update_npc] run function internal:common/collision/update_npc
execute if score @s[tag=world_builder.spawn_npc] has_collided matches 1 run function internal:common/collision/spawn_npc
execute if score @s[tag=world_builder.spawn_gob] has_collided matches 1 run function internal:common/collision/spawn_gob
execute if entity @s[tag=world_builder.despawn_npc] run function internal:common/collision/despawn_npc
execute if entity @s[tag=world_builder.despawn_gob] run function internal:common/collision/despawn_gob

#loop and life conditions
execute positioned ^ ^ ^0.20 unless score @s has_collided matches 1 run function internal:common/collision/this.move_forward
