...
tellraw @s[tag=_t.h0_m0] {"translate":"server_timestamp","with":[{"text":"0"},{"score":{"name":"#world","objective":"__hours"}},{"text":"0"},{"score":{"name":"#world","objective":"__minutes"}},{"translate":"event_type.log.damage_taken_amb","with":[{"score":{"name":"@s","objective":"dmg_in0"},"color":"white"},{"translate":"event_type.log.damage_fatal","with":[{"score":{"name":"@s[scores={TEMP=1..}]","objective":"TEMP"},"color":"white"}]}]}],"color":"gray"}
tellraw @s[tag=_t.h0_m1] {"translate":"server_timestamp","with":[{"text":"0"},{"score":{"name":"#world","objective":"__hours"}},{"text":""},{"score":{"name":"#world","objective":"__minutes"}},{"translate":"event_type.log.damage_taken_amb","with":[{"score":{"name":"@s","objective":"dmg_in0"},"color":"white"},{"translate":"event_type.log.damage_fatal","with":[{"score":{"name":"@s[scores={TEMP=1..}]","objective":"TEMP"},"color":"white"}]}]}],"color":"gray"}
tellraw @s[tag=_t.h1_m0] {"translate":"server_timestamp","with":[{"text":""},{"score":{"name":"#world","objective":"__hours"}},{"text":"0"},{"score":{"name":"#world","objective":"__minutes"}},{"translate":"event_type.log.damage_taken_amb","with":[{"score":{"name":"@s","objective":"dmg_in0"},"color":"white"},{"translate":"event_type.log.damage_fatal","with":[{"score":{"name":"@s[scores={TEMP=1..}]","objective":"TEMP"},"color":"white"}]}]}],"color":"gray"}
tellraw @s[tag=_t.h1_m1] {"translate":"server_timestamp","with":[{"text":""},{"score":{"name":"#world","objective":"__hours"}},{"text":""},{"score":{"name":"#world","objective":"__minutes"}},{"translate":"event_type.log.damage_taken_amb","with":[{"score":{"name":"@s","objective":"dmg_in0"},"color":"white"},{"translate":"event_type.log.damage_fatal","with":[{"score":{"name":"@s[scores={TEMP=1..}]","objective":"TEMP"},"color":"white"}]}]}],"color":"gray"}
