...
execute if entity @e[type=#internal:creature,tag=ENTITY_FLAG_IN_COMBAT,distance=0..11.999] run scoreboard players set @s[scores={combat_reset_t=1..}] combat_reset_t 0
