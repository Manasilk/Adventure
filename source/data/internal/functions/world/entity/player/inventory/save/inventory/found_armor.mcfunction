execute store result storage account.character:inventory inventory[-1].Slot byte 1 run scoreboard players remove #player.inventory_slot TEMP 100

data modify storage account.character:inventory armor append from storage account.character:inventory inventory[-1]
