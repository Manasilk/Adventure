...
scoreboard players set @s[predicate=internal:player/selected_item/sword] wepsound 1
scoreboard players set @s[predicate=internal:player/selected_item/axe] wepsound 2
