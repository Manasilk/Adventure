...
execute unless predicate internal:biome/deep_ocean run scoreboard players remove @s[tag=ENTITY_FLAG_SWIMMING_FATIGUE,scores={fatigue_level=1..59}] fatigue_level 6
