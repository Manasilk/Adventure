...
execute if score @s fatigue_level matches 60 run function internal:world/entity/player/reset_player_fatigue
scoreboard players remove @s[tag=ENTITY_FLAG_SWIMMING_FATIGUE,scores={fatigue_level=0..59},advancements={internal:world/fatigue/biome_deep_ocean=false}] fatigue_level 6
