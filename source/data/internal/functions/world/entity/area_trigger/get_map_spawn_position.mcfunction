...
#>x
scoreboard players operation @s[scores={override_min.x=0}] min = #temp entity.pos_x
scoreboard players operation @s[scores={override_min.x=0}] max = #temp entity.pos_x
...
function internal:world/world/math/random/lcg_range
scoreboard players operation #temp map_pos.x = @s rand
#>y
scoreboard players operation @s[scores={override_min.y=0}] min = #temp entity.pos_y
scoreboard players operation @s[scores={override_min.y=0}] max = #temp entity.pos_y
...
#>z
scoreboard players operation @s[scores={override_min.z=0}] min = #temp entity.pos_z
scoreboard players operation @s[scores={override_min.z=0}] max = #temp entity.pos_z
...
#execute as @e[type=#internal:area_trigger,tag=MAP_SPAWN_TARGET,distance=0..1.501,sort=nearest,limit=1] at @s run function internal:world/entity/area_trigger/get_map_target_position_spc
