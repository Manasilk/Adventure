...
spreadplayers ~ ~ 0.0 18.0 false @e[type=minecraft:pillager,tag=!area_trigger.spread_summoned_spawn,distance=0..25.999]
tag @e[type=minecraft:pillager,tag=!area_trigger.spread_summoned_spawn,distance=0..25.999] add area_trigger.spread_summoned_spawn
