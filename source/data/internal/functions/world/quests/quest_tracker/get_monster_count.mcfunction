...
scoreboard players reset @a[tag=ENTITY_FLAG_QUEST_TARGET,distance=0..31.999,limit=1] quest_kill0
scoreboard players reset @a[tag=ENTITY_FLAG_QUEST_TARGET,distance=0..31.999,limit=1] quest_kill1
scoreboard players reset @a[tag=ENTITY_FLAG_QUEST_TARGET,distance=0..31.999,limit=1] quest_kill2
scoreboard players reset @a[tag=ENTITY_FLAG_QUEST_TARGET,distance=0..31.999,limit=1] quest_kill3
...
execute if score @s[tag=!quest.complete_objective_1,scores={task_objectives=2..,npc_count1=1..}] npc_count1 >= @s quest_kill1 run scoreboard players add @s task_pobj_count 1
...
execute if score @s[tag=!quest.complete_objective_2,scores={task_objectives=3..,npc_count2=1..}] npc_count2 >= @s quest_kill2 run scoreboard players add @s task_pobj_count 1
...
execute if score @s[tag=!quest.complete_objective_3,scores={task_objectives=4,npc_count3=1..}] npc_count3 >= @s quest_kill3 run scoreboard players add @s task_pobj_count 1
