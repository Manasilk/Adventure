...
tag @e[type=minecraft:villager,distance=0..0.001,sort=nearest,limit=1] add _e.set_flag_questgiver
tag @e[type=minecraft:villager,distance=0..0.001,sort=nearest,limit=1] add _e.set_flag_quest_start
tag @e[type=minecraft:villager,distance=0..0.001,sort=nearest,limit=1] add _e.set_flag_quest_end