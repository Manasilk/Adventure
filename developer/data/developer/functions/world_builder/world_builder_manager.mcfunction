...
execute if score @s[predicate=developer:world_builder/world_builder_tool] chat.right_mouse matches 1.. run function developer:world_builder/on_right_mouse