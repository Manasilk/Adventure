...
function fairbox:metrics/fairbox.get_positive_int
...
execute if score @s[tag=FB_FLAG_PLAYER_IGNORE] _FB._PosX-1 > @s _FB._LimitH run function fairbox:events/fairbox.disallow_teleport
execute if score @s[tag=FB_FLAG_PLAYER_IGNORE] _FB._PosZ-1 > @s _FB._LimitH run function fairbox:events/fairbox.disallow_teleport
execute if score @s[tag=FB_FLAG_PLAYER_IGNORE] _FB._PosY-1 > @s _FB._LimitV run function fairbox:events/fairbox.disallow_teleport
