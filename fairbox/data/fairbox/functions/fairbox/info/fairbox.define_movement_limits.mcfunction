...
execute if entity @s[tag=!FB_FLAG_PLAYER_IGNORE,tag=SPELL_AURA_TELEPORT] run function fairbox:fairbox/events/fairbox.allow_teleport
execute if entity @s[tag=!FB_FLAG_PLAYER_IGNORE,tag=SPELL_EFFECT_ENDER_PEARL] run function fairbox:fairbox/events/fairbox.allow_teleport
execute if entity @s[tag=!FB_FLAG_PLAYER_IGNORE,tag=SPELL_EFFECT_CHORUS_FRUIT] run function fairbox:fairbox/events/fairbox.allow_teleport
execute if entity @s[tag=!FB_FLAG_PLAYER_IGNORE,tag=rbac.commands] run function fairbox:fairbox/events/fairbox.allow_teleport