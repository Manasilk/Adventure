...
summon minecraft:area_effect_cloud ~ ~ ~ {Age:0,Duration:0,WaitTime:0,Tags:["ENTITY_TYPE_GENERIC","ENTITY_ACTION_IGNORE","ENTITY_FLAG_TELEPORT_TARGET","ENTITY_FLAG_EXTRA_TRIGGER","FB_TELEPORT_TARGET"]}
...
kill @e[type=#server:area_trigger,tag=FB_TELEPORT_TARGET]