...
scoreboard objectives add _FB._EnderPearl minecraft.used:minecraft.ender_pearl {"dbc.fairbox.ender_pearl"}
scoreboard objectives add _FB._ChorusFruit minecraft.used:minecraft.chorus_fruit {"dbc.fairbox.chorus_fruit"}
